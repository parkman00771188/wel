...
echo ============================================
echo.
echo This registers a Windows scheduled task that checks USGS every 30
...
schtasks /Create /F /SC MINUTE /MO 30 /TN "WelEarthquakeAutoUpdate" ^
...
echo [ok] scheduled task "WelEarthquakeAutoUpdate" registered (every 30 min).
