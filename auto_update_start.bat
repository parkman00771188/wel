...
echo ============================================
echo.
echo This registers a Windows scheduled task that checks USGS every 10
...
schtasks /Create /F /SC MINUTE /MO 10 /TN "WelEarthquakeAutoUpdate" ^
...
echo [ok] scheduled task "WelEarthquakeAutoUpdate" registered (every 10 min).
